...
/*                                                                           */
/*****************************************************************************/
void bcg729Encoder(bcg729EncoderChannelContextStruct *encoderChannelContext, const int16_t inputFrame[], uint8_t bitStream[])
{
	int i;
	...
	/*****************************************************************************************/
	/*** on frame basis : LP Analysis, Open-loop pitch search               ***/
	memcpy(encoderChannelContext->signalLastInputFrame, inputFrame, L_FRAME*sizeof(inputFrame[0]));
